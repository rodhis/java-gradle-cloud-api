package rodhis.java.gradlecloudapi.service.impl;

import rodhis.java.gradlecloudapi.domain.model.User;
import rodhis.java.gradlecloudapi.domain.repository.UserRepository;
import rodhis.java.gradlecloudapi.service.UserService;
import rodhis.java.gradlecloudapi.service.exception.BusinessException;
import rodhis.java.gradlecloudapi.service.exception.NotFoundException;
...
@Service
public class UserServiceImpl implements UserService { //garante a não exposição da interface de serviço
